...
List<SimilarProductsData> similarProductsDataFromJson(String str) =>
    List<SimilarProductsData>.from(
        json.decode(str).map((x) => SimilarProductsData.fromJson(x)));

String similarProductsDataToJson(List<SimilarProductsData> data) =>
...
class SimilarProductsData {
  ...
  factory SimilarProductsData.fromJson(Map<String, dynamic> json) =>
      SimilarProductsData(
        id: json["id"],
        sku: json["sku"],
