...
class MillionMartPeofile extends StatefulWidget {
  MillionMartPeofile({Key? key, required this.appbar}) : super(key: key);
  @override
  bool appbar = false;

  _MillionMartPeofileState createState() => _MillionMartPeofileState();
}

class _MillionMartPeofileState extends State<MillionMartPeofile>
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  // var data = await paginationController();
                  // print("Api Data on Profile Screen "+data[0]["product_type"].toString());
                },
              ),
            )
          ],
          ...
          return networkController.networkStatus.value == true
              ? Scaffold(
                  ...
                  appBar: widget.appbar == false
                      ? getAppBar('profile'.tr, context)
                      : PreferredSize(
                          preferredSize: Size.fromHeight(0), child: AppBar()),
                  body: Center(
                    child: loginCheck.value
                        ? _showContent()
                        : Column(
