...
class MillionMartCatogeryAll extends StatefulWidget {
  MillionMartCatogeryAll({Key? key}) : super(key: key);

  @override
  _MillionMartCatogeryAllState createState() => _MillionMartCatogeryAllState();
}

class _MillionMartCatogeryAllState extends State<MillionMartCatogeryAll> {
  int offset = perPage;
  int total = 0;
