...
class MillionMartOrderDetails extends StatefulWidget {
  MillionMartOrderDetails({Key? key}) : super(key: key);

  @override
  _MillionMartOrderDetailsState createState() =>
      _MillionMartOrderDetailsState();
}

class _MillionMartOrderDetailsState extends State<MillionMartOrderDetails>
            ...
            child: Row(
              ...
              children: [
                Flexible(
                    ...
                    child: Divider(
                      thickness: 2,
                      color: prDate == null ? Colors.grey : primaryColor,
                    )),
                Column(
                  children: [
                    Text(
            ...
            child: Row(
              ...
              children: [
                Flexible(
                    ...
                    child: Divider(
                      thickness: 2,
                      color: sDate == null ? Colors.grey : primaryColor,
                    )),
                Column(
                  children: [
                    Text(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                    child: Divider(
                  thickness: 2,
                  color: dDate == null ? Colors.grey : primaryColor,
                )),
                Column(
                  children: [
                    Text(
