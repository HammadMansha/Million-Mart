...
const String WELCOME_MillionMart = 'Welcome to Million Mart';
const String ECOMMERCE_APP_FOR_ALL_BUSINESS =
    'The ecommerce app for all business';
...
const String selectVarient = 'select_varient';
...
const String UPDATE_PROFILE_LBL = 'User Profile';
...
const String NO_CART = 'cart_empty';
...
const String SHOP_NOW = 'shop_now';
const String OUT_OF_STOCK_LBL = "Out Of Stock";


// const String PAYPAL_RESPONSE_URL = "http://MillionMart.wrteam.in/app/v1/api/app_payment_status";//?amt=10.00&cc=USD&item_name=Welcome%20&item_number=7&st=Completed&tx=50X78734DF4190710";'

String CUR_CURRENCY = 'Rss';
String CUR_USERID = '';
String CUR_USERNAME = '';
int CUR_CART_COUNT = 0;
String CUR_BALANCE = '';
